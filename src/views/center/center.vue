  ...
  <div class="center1" >
    ...
    <div class="listTop">
        <van-grid :column-num="5" :border="false">
            ...
            <van-grid-item text="评价送悠币">
                <img src="https://img05.yiguoimg.com/d/web/180608/01261/105825/evaluate.png" alt="">
                <span>评价送悠币</span>
            </van-grid-item>
    ...
    <div class="main">
        <van-grid :column-num="4">
            ...
            <van-grid-item class="main_list" text="文字" >
               <img src="https://img06.yiguoimg.com/d/web/181121/00591/143839/account-icon.png" >
               <span>账户余额</span>
            </van-grid-item>
            <van-grid-item class="main_list" text="文字" >
...
.header {
  width: 100%;
  height: 140px;
  background: #2dd282 url(https://img06.yiguoimg.com/d/web/180517/01262/143351/bgimg.jpg) ;
